...
public enum GameDataRedis {
    ...
    HOST_AUTHOR_REDIS(DataType.SERVER, "game/<gameID>/author", true),
    HOST_ACCESS_REDIS(DataType.SERVER, "game/<gameID>/access", true),
    HOST_ALLOWPLAYER_REDIS(DataType.SERVER, "game/<gameID>/allpl", true),
    HOST_ALLOWSPECTATOR_REDIS(DataType.SERVER, "game/<gameID>/allspec", true),

    GAME_ID_REDIS(DataType.GLOBAL, "game/id", false),
    LIST_GAME_REDIS(DataType.GLOBAL, "game/list", false),
    LIST_HOST_REDIS(DataType.GLOBAL, "game/host/list", false),
    MAP_SERVER_REDIS(DataType.GLOBAL, "game/map", false);
