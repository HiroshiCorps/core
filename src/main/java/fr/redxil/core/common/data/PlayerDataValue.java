...
public enum PlayerDataValue {
    ...
    PLAYER_RANK_SQL(DataBaseType.SQL, DataType.PLAYER, "member_power", false, false),
    ...
    PLAYER_BLACKLIST_REDIS(DataBaseType.REDIS, DataType.PLAYER, "player/<memberID>/blackList", false, true),
    PLAYER_BLACKLIST_SQL(DataBaseType.SQL, DataType.PLAYER, "blackList", false, false),

    PLAYER_FRIENDLIST_REDIS(DataBaseType.REDIS, DataType.PLAYER, "player/<memberID>/friendList", false, true),
    PLAYER_FRIENDLIST_SQL(DataBaseType.SQL, DataType.PLAYER, "friendList", false, false),

    PLAYER_FRIENDRECEIVEDLIST_REDIS(DataBaseType.REDIS, DataType.PLAYER, "player/<memberID>/receivedList", false, true),
    PLAYER_FRIENDRECEIVEDLIST_SQL(DataBaseType.SQL, DataType.PLAYER, "receivedList", false, false),

    PLAYER_FRIENDSENDEDLIST_REDIS(DataBaseType.REDIS, DataType.PLAYER, "player/<memberID>/sendList", false, true),
